"""FastAPI application factory for alert-service.
...
from alert_app.api.router import api_router
from alert_app.core.config import get_settings

settings = get_settings()
setup_logging(service=settings.service_name)

app = FastAPI(
    title="RxGuard Alert Service",
    description="Severity-tiered alerts, explanation generation, prioritization, override/acknowledge workflow.",
    version="0.1.0",
)
