"""Interaction-service application."""
...
from interaction_app.api.router import api_router
...
app = FastAPI(
    title="RxGuard Interaction Service",
    description="Core engine: drug standardization, N-ary interaction checking, severity classification, manual-simulated engine, benchmark runner.",
    version="0.1.0",
    lifespan=lifespan,
)
